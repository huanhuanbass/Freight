...
if freq_rt=='Weekly':
    ...
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear+1),key='spotyear11rtr')
    ...
    yrlist=list(rtr['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear+1),key='spotyear22rtr')
    rtr=rtr[rtr['Year'].isin(yrsl)]
    ...
    yrlist=list(rtr['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear),key='spotyear33rtr')
    rtr=rtr[rtr['Year'].isin(yrsl)]
...
if freq_rt=='Weekly':
    ...
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear+1),key='spotyear11rtsp')
    ...
    yrlist=list(rtsp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear+1),key='spotyear22rtsp')
    rtsp=rtsp[rtsp['Year'].isin(yrsl)]
    ...
    yrlist=list(rtsp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear),key='spotyear33rtsp')
    rtsp=rtsp[rtsp['Year'].isin(yrsl)]
