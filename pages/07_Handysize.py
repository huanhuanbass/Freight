...
st.title('Baltic Exchange Handysize 7TC')
st.text('Dry Bulk Freight (Handysize) Interactive Dashboard')
...
sllist1=st.multiselect('Select Contracts',options=hs7tc_pt.columns,default=[s0,m1,m2,m3,q1,q2,q3,q4,y1],key='sl1')
hs7tc_sl=hs7tc_pt[sllist1]
...
hs7tc_sl=hs7tc_sl[pd.to_datetime(hs7tc_sl.index)>=pd.to_datetime(rangestart1)]
lplot=px.line(hs7tc_sl,width=1000,height=500,title='HS7TC Spot and Fixed Forward Contracts Historical Price')
...
sllist_r=st.multiselect('Select Contracts',options=hs7tc_roll.columns,default=['HS7TC','TC_H38+1MON','TC_H38+2MON','TC_H38+3MON','TC_H38+1Q','TC_H38+2Q','TC_H38+3Q','TC_H38+4Q','TC_H38+1CAL'],key='102')
hs7tc_sl=hs7tc_roll[sllist_r]
...
hs7tc_sl=hs7tc_sl[pd.to_datetime(hs7tc_sl.index)>=pd.to_datetime(rangestart_r)]
lplot=px.line(hs7tc_sl,width=1000,height=500,title='HS7TC Spot and Rolling Forward Contracts Historical Price')
lplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
lplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
lplot.update_traces(connectgaps=True)
lplot.update_layout(template=draft_template)
...
contractlist=st.selectbox('Select Spot or Forward Contract',options=[q1]+list(hs7tc_pt.columns))
...
hs7tc_contract=hs7tc_pt[[contractlist]]
hs7tc_contract.dropna(inplace=True)

hs7tc_contract.sort_index(inplace=True)
indicator_mast = SMAIndicator(close=hs7tc_contract[contractlist], window=ma1)
indicator_malt = SMAIndicator(close=hs7tc_contract[contractlist], window=ma2)
indicator_bb = BollingerBands(close=hs7tc_contract[contractlist], window=bb, window_dev=2)
hs7tc_contract['ma_st'] = indicator_mast.sma_indicator()
hs7tc_contract['ma_lt'] = indicator_malt.sma_indicator()
hs7tc_contract['bb_m'] = indicator_bb.bollinger_mavg()
hs7tc_contract['bb_h'] = indicator_bb.bollinger_hband()
hs7tc_contract['bb_l'] = indicator_bb.bollinger_lband()


contractplot=px.line(hs7tc_contract,width=1000,height=500,title='HS7TC Fixed Contract Bollinger Bands and Moving Average')
...
contractlist_r=st.selectbox('Select Spot or Forward Contract',options=['TC_H38+1MON']+list(s10tc_roll.columns),key='201')
...
hs7tc_contract=hs7tc_roll[[contractlist_r]]
hs7tc_contract.dropna(inplace=True)
hs7tc_contract=hs7tc_contract[pd.to_datetime(hs7tc_contract.index)>=pd.to_datetime(rangestart_r)]

hs7tc_contract.sort_index(inplace=True)
indicator_mast = SMAIndicator(close=hs7tc_contract[contractlist_r], window=ma1_r)
indicator_malt = SMAIndicator(close=hs7tc_contract[contractlist_r], window=ma2_r)
indicator_bb = BollingerBands(close=hs7tc_contract[contractlist_r], window=bb_r, window_dev=2)
hs7tc_contract['ma_st'] = indicator_mast.sma_indicator()
hs7tc_contract['ma_lt'] = indicator_malt.sma_indicator()
hs7tc_contract['bb_m'] = indicator_bb.bollinger_mavg()
hs7tc_contract['bb_h'] = indicator_bb.bollinger_hband()
...
contractplot=px.line(hs7tc_contract,width=1000,height=500,title='HS7TC Rolling Contract Bollinger Bands and Moving Average')
contractplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
contractplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
contractplot.update_layout(template=draft_template)
st.plotly_chart(contractplot)

st.markdown('## **HS7TC Spot and Rolling FFA Contracts Seasonality**')
contractlist_r=st.selectbox('Select Spot or Forward Contract',options=list(hs7tc_roll.columns),key='211')
freq=st.radio('Select Frequency',options=['Daily','Weekly','Monthly','Quarterly'],key='spotfreq')
hs7tc_sp=hs7tc_roll[[contractlist_r]]
hs7tc_sp.index=pd.to_datetime(hs7tc_sp.index)

avgly=hs7tc_sp[hs7tc_sp.index.year==today.year-1][contractlist_r].mean()
avgty=hs7tc_sp[hs7tc_sp.index.year==today.year][contractlist_r].mean()
day_ytd=hs7tc_sp[hs7tc_sp.index.year==today.year].index.day_of_year.max()
avglyytd=hs7tc_sp[(hs7tc_sp.index.year==today.year-1)&(hs7tc_sp.index.day_of_year<=day_ytd)][contractlist_r].mean()

if freq=='Weekly':
    hs7tc_sp['Year']=hs7tc_sp.index.year
    hs7tc_sp['Week']=hs7tc_sp.index.isocalendar().week
    hs7tc_sp.loc[hs7tc_sp[hs7tc_sp.index.date==date(2016,1,2)].index,'Week']=0
    hs7tc_sp.loc[hs7tc_sp[hs7tc_sp.index.date==date(2021,1,2)].index,'Week']=0
    hs7tc_sp.loc[hs7tc_sp[hs7tc_sp.index.date==date(2022,1,1)].index,'Week']=0
    yrlist=list(hs7tc_sp['Year'].unique())
    ...
    hs7tc_sp=hs7tc_sp[hs7tc_sp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_sp.pivot_table(index='Week',columns='Year',values=contractlist_r,aggfunc='mean')
    maxi=hs7tc_sppt.max().max()
    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title=str(contractlist_r)+' Weekly Seasonality')
    ...
    hs7tc_sp['Year']=hs7tc_sp.index.year
    hs7tc_sp['Month']=hs7tc_sp.index.month
    yrlist=list(hs7tc_sp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-6,curryear+1),key='spotyear2')
    hs7tc_sp=hs7tc_sp[hs7tc_sp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_sp.pivot_table(index='Month',columns='Year',values=contractlist_r,aggfunc='mean')
    maxi=hs7tc_sppt.max().max()
    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title=str(contractlist_r)+' Monthly Seasonality')
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
    ...
    hs7tc_sp['Year']=hs7tc_sp.index.year
    hs7tc_sp['Quarter']=hs7tc_sp.index.quarter
    yrlist=list(hs7tc_sp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-6,curryear),key='spotyear3')
    hs7tc_sp=hs7tc_sp[hs7tc_sp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_sp.pivot_table(index='Quarter',columns='Year',values=contractlist_r,aggfunc='mean')
    maxi=hs7tc_sppt.max().max()
    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title=str(contractlist_r)+' Quarterly Seasonality')
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
    ...
    hs7tc_sp['Year']=hs7tc_sp.index.year
    hs7tc_sp['Day']=hs7tc_sp.index.day_of_year
    yrlist=list(hs7tc_sp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-3,curryear+1),key='spotyear3')
    hs7tc_sp=hs7tc_sp[hs7tc_sp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_sp.pivot_table(index='Day',columns='Year',values=contractlist_r,aggfunc='mean')
    maxi=hs7tc_sppt.max().max()
    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title=str(contractlist_r)+' Daily Seasonality')
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
...
sllist2=st.multiselect('Select Contracts',options=hs7tc_pt.columns,default=[s0,m0,m1,m2,m3,m4,q1,q2,q3,q4,y1,y2],key='2')
hs7tc_fc=hs7tc_pt[sllist2]
hs7tc_fct=hs7tc_fc.transpose()
...
sllist3=st.multiselect('Select Dates',options=hs7tc_fct.columns,default=[tday,lday,lweek,lmonth],key='3')
hs7tc_fctsl=hs7tc_fct[sllist3]
fctplot=px.line(hs7tc_fctsl,width=1000,height=500,title='HS7TC Forward Curve')
...
st.markdown('#### **----Fixed Contracts**')
tsp1=st.selectbox('Select Contract 1',options=[q1]+list(hs7tc_pt.columns))
tsp2=st.selectbox('Select Contract 2',options=[q2]+list(hs7tc_pt.columns))

if tsp1!=tsp2:
    hs7tc_tsp=hs7tc_pt[[tsp1,tsp2]]
    hs7tc_tsp.dropna(inplace=True)
    hs7tc_tsp['Spread']=hs7tc_tsp[tsp1]-hs7tc_tsp[tsp2]
    tspplot=px.line(hs7tc_tsp[['Spread']],width=1000,height=500,title='S10TC Fixed Contract Time Spread: '+str(tsp1)+' minus '+str(tsp2))
...
st.markdown('#### **----Rolling Contracts**')
tsp1_r=st.selectbox('Select Contract 1',options=['TC_H38+1MON']+list(s10tc_roll.columns))
tsp2_r=st.selectbox('Select Contract 2',options=['TC_H38+2MON']+list(s10tc_roll.columns))

if tsp1_r!=tsp2_r:
    hs7tc_tsp=hs7tc_roll[[tsp1_r,tsp2_r]]
    hs7tc_tsp.dropna(inplace=True)
    hs7tc_tsp['Spread']=hs7tc_tsp[tsp1_r]-hs7tc_tsp[tsp2_r]
    tspplot=px.line(hs7tc_tsp[['Spread']],width=1000,height=500,title='HS7TC Rolling Contract Time Spread: '+str(tsp1_r)+' minus '+str(tsp2_r))
    tspplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    tspplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    tspplot.update_layout(template=draft_template)
    st.plotly_chart(tspplot)
...
if freq_r=='Weekly':
    hs7tc_tsp['Year']=hs7tc_tsp.index.year
    hs7tc_tsp['Week']=hs7tc_tsp.index.isocalendar().week
    hs7tc_tsp.loc[hs7tc_tsp[hs7tc_tsp.index.date==date(2016,1,2)].index,'Week']=0
    hs7tc_tsp.loc[hs7tc_tsp[hs7tc_tsp.index.date==date(2021,1,2)].index,'Week']=0
    hs7tc_tsp.loc[hs7tc_tsp[hs7tc_tsp.index.date==date(2022,1,1)].index,'Week']=0
    yrlist=list(hs7tc_tsp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-4,curryear+1),key='spotyear11')
    hs7tc_tsp=hs7tc_tsp[hs7tc_tsp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_tsp.pivot_table(index='Week',columns='Year',values='Spread',aggfunc='mean')

    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title='Rolling Contract Time Spread Weekly Seasonality '+str(tsp1_r)+' minus '+str(tsp2_r))
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
    ...
    hs7tc_tsp['Year']=hs7tc_tsp.index.year
    hs7tc_tsp['Month']=hs7tc_tsp.index.month
    yrlist=list(hs7tc_tsp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-4,curryear+1),key='spotyear22')
    hs7tc_tsp=hs7tc_tsp[hs7tc_tsp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_tsp.pivot_table(index='Month',columns='Year',values='Spread',aggfunc='mean')

    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title='Rolling Contract Time Spread Monthly Seasonality '+str(tsp1_r)+' minus '+str(tsp2_r))
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
    ...
    hs7tc_tsp['Year']=hs7tc_tsp.index.year
    hs7tc_tsp['Quarter']=hs7tc_tsp.index.quarter
    yrlist=list(hs7tc_tsp['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-4,curryear),key='spotyear33')
    hs7tc_tsp=hs7tc_tsp[hs7tc_tsp['Year'].isin(yrsl)]
    hs7tc_sppt=hs7tc_tsp.pivot_table(index='Quarter',columns='Year',values='Spread',aggfunc='mean')

    spotplot=px.line(hs7tc_sppt,width=1000,height=500,title='Rolling Contract Time Spread Quarterly Seasonality '+str(tsp1_r)+' minus '+str(tsp2_r))
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
...
hs7tc_pt.rename(columns={'HS7TC':'Spot'},inplace=True)




ssp_opt=list(set(hs7tc_pt.columns)&set(s10tc_pt.columns))
ssp_opt.sort()
...
hs7tc_fcssp=hs7tc_pt[fcssp_multiopt]
fcssp_opt=list(set(hs7tc_fcssp.index)&set(s10tc_fcssp.index))
...
hs7tc_fcssp=hs7tc_fcssp.filter(items=[fcssp],axis=0)
hs7tc_fcssp=hs7tc_fcssp.transpose()
hs7tc_fcssp.columns=['Handysize']
cp_fcssp=pd.merge(s10tc_fcssp,hs7tc_fcssp,how='outer',left_index=True,right_index=True)


fcsspplot=px.line(cp_fcssp,width=1000,height=500,title='HS7TC Forward Curve Size Spread')
...
for j in ssp2:
    ...
    hs7tc_ssp2=hs7tc_pt[[j]]
    hs7tc_ssp2.columns=['Handysize']
    ssp_mg2=pd.merge(s10tc_ssp2,hs7tc_ssp2,how='inner',left_index=True,right_index=True)
    ssp_mg2[str(j)+' Size Spread']=ssp_mg2['Supramax']-ssp_mg2['Handysize']
...
sspplot2=px.line(ssp_chart2,width=1000,height=500,title='Fixed Contract Size Spread: S10TC minus HS7TC')
...
hs7tc_roll.rename(columns={'HS7TC':'TC_H38Spot'},inplace=True)

rsp_opt=pd.Series(hs7tc_roll.columns.values)
rsp_opt=rsp_opt.str.removeprefix('TC_H38')
...
rsp_chart=pd.merge(hs7tc_roll[rsp_s],s10tc_roll[rsp_p],left_index=True,right_index=True,how='inner')
...
if freq_r=='Weekly':
    ...
    spotplot=px.line(p4tc_sppt,width=1000,height=500,title=str(rsp)+' Rolling Contract S10TC Minus HS7TC Size Spread Weekly Seasonality')
    spotplot.update_xaxes(ticks=plot_ticks, tickwidth=plot_tickwidth,  ticklen=plot_ticklen)
    spotplot.update_layout(title_font_color=plot_title_font_color,title_font_size=plot_title_font_size,legend_font_size=plot_legend_font_size,xaxis=plot_axis,yaxis=plot_axis)
    spotplot['data'][-1]['line']['width']=5
    spotplot['data'][-1]['line']['color']='black'
    ...
    yrlist=list(rsp_chart['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-4,curryear+1),key='spotyear22rr')
    rsp_chart=rsp_chart[rsp_chart['Year'].isin(yrsl)]
    ...
    yrlist=list(rsp_chart['Year'].unique())
    yrlist.sort(reverse=True)
    yrsl=st.multiselect('Select Years',options=yrlist,default=np.arange(curryear-4,curryear),key='spotyear33rr')
    rsp_chart=rsp_chart[rsp_chart['Year'].isin(yrsl)]
...
hs7tc_df=hs7tc_pt[[s0,m0,m1,m2,m3,m4,q0,q1,q2,q3,q4,y1,y2,y3,y4]]
hs7tc_=pd.concat([hs7tc_df.loc[[tday.date()]],hs7tc_df.loc[[lday.date()]],hs7tc_df.loc[[lweek.date()]],hs7tc_df.loc[[lmonth.date()]]])
st.write(hs7tc_.style.format('{:,.0f}'))

st.markdown('#### **Change**')
hs7tc_.loc['DoD Chg']=hs7tc_df.loc[tday.date()]-hs7tc_df.loc[lday.date()]
hs7tc_.loc['WoW Chg']=hs7tc_df.loc[tday.date()]-hs7tc_df.loc[lweek.date()]
hs7tc_.loc['MoM Chg']=hs7tc_df.loc[tday.date()]-hs7tc_df.loc[lmonth.date()]
hs7tc_chg=pd.concat([hs7tc_.loc[['DoD Chg']],hs7tc_.loc[['WoW Chg']],hs7tc_.loc[['MoM Chg']]])
st.write(hs7tc_chg.style.format('{:,.0f}'))

st.markdown('#### **Change in Percentage**')
hs7tc_.loc['DoD Chg %']=hs7tc_.loc['DoD Chg']/hs7tc_df.loc[lday.date()]
hs7tc_.loc['WoW Chg %']=hs7tc_.loc['WoW Chg']/hs7tc_df.loc[lweek.date()]
hs7tc_.loc['MoM Chg %']=hs7tc_.loc['MoM Chg']/hs7tc_df.loc[lmonth.date()]
hs7tc_chgpct=pd.concat([hs7tc_.loc[['DoD Chg %']],hs7tc_.loc[['WoW Chg %']],hs7tc_.loc[['MoM Chg %']]])
st.write(hs7tc_chgpct.style.format('{:,.2%}'))